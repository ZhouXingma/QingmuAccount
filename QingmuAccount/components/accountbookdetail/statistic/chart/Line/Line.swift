...
public struct Line: View {
    ...
    @State var lineBackgroundColor:Color = Colors.GradientUpperBlue
    ...
    public var body: some View {
        ZStack {
            if(self.showFull && self.showBackground){
                self.closedPath
                    .fill(LinearGradient(gradient: Gradient(colors: [lineBackgroundColor.opacity(0.8), lineBackgroundColor.opacity(0.01)]), startPoint: .bottom, endPoint: .top))
...
struct Line_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{ geometry in
            Line(data: ChartData(points: [12,230,10,54]), frame: .constant(geometry.frame(in: .local)), touchLocation: .constant(CGPoint(x: 30, y: 12)), showIndicator: .constant(true), minDataValue: .constant(nil), maxDataValue: .constant(nil))
